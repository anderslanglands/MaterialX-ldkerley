...
void ShaderGenerator::registerTypeDefs(ConstDocumentPtr doc, GenContext& context)
{
...
void ShaderGenerator::registerStructTypeDefs(ConstDocumentPtr doc, GenContext& context)
{
    for (const auto& mxTypeDef : doc->getTypeDefs())
    {
        ...
        context.registerCustomTypeDesc(typeDefName, TypeDesc::BASETYPE_STRUCT, TypeDesc::SEMANTIC_NONE, 1, structMemberDescs);
    }
